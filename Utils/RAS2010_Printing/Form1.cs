...
namespace Unmanaged_RAS10_CSharp_Printers
{
	...
	public class frmMain : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            this.cboCurrentPaperTrays.SelectedIndexChanged += new System.EventHandler(this.cboCurrentPaperTrays_SelectedIndexChanged);
            // 
		...
		private void btnOpenReport_Click(object sender, System.EventArgs e) 
		{
			...
			if (openFileDialog.ShowDialog() == DialogResult.OK) 
			{
                ...
                try
                {
                    ...
                    btnSQLStatement.Text += "\nReport Document Loaded in: " + difference.Minutes + ":" + difference.Seconds + "\r\n";
        ...
        private void btnPOController_Click_1(object sender, System.EventArgs e) // Print To P button
		{
            ...
            if (rdoCurrent.Checked)
            {
                ...
                string MyRptName = rpt.FileName;
                MyRptName = MyRptName.Substring(MyRptName.LastIndexOf(@"\", StringComparison.Ordinal) + 1, (rpt.FileName.Length - 3) - (MyRptName.LastIndexOf(@"\", StringComparison.Ordinal) + 2));
        ...
        private void cboCurrentPaperTrays_SelectedIndexChanged(object sender, EventArgs e)
        {
